 ...
 */
class CdmBotTrainer<P, R, M>(val processors: Int = Runtime.getRuntime().availableProcessors(), val steps: Array<Int> = arrayOf(50, 10, 5, 1)) : BotTrainer<P, R, M> where M : Comparable<M>, M : BotMetrica {
