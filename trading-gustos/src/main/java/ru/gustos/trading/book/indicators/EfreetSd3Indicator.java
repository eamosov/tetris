...
public class EfreetSd3Indicator extends BaseIndicator {
    public static int Id;

    public EfreetSd3Indicator(IndicatorInitData data) {
        super(data);
        Id = data.id;
    }
    ...
    public void calcValues(Sheet sheet, double[] values) {
        ...
        final BotLogic logic = LogicFactory.Companion.getLogic("sd3",
