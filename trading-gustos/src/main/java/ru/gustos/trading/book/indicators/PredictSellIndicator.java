...
public class PredictSellIndicator extends BaseIndicator{
    public static int Id;

    public PredictSellIndicator(IndicatorInitData data){
        super(data);
        Id = data.id;
    }
...
//        String s = doExport(sheet, TargetSellIndicator.Id,true);
//        string2file("d:/tetrislibs/temptrainS.arff",s);
//        s = doExport(sheet, TargetSellIndicator.Id,false);
//        string2file("d:/tetrislibs/tempexamS.arff",s);
//        BufferedReader br = null;
//        Arrays.fill(values,0);
//        try {
//            br = new BufferedReader(new FileReader("d:/tetrislibs/temptrainS.arff"));
//            Instances trainData = new Instances(br);
//            trainData.setClassIndex(trainData.numAttributes() - 1);
//            br.close();
//            br = new BufferedReader(new FileReader("d:/tetrislibs/tempexamS.arff"));
//            Instances examData = new Instances(br);
//            examData.setClassIndex(examData.numAttributes() - 1);
//            br.close();
//
//            System.out.println("random forest for ysell");
